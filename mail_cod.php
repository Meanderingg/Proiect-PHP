...
try {
  ...
  $username = "feedback@tsandulescu.daw.ssmr.ro";
  $password = "strongpassword";
 
  $mail->SMTPDebug  = 0;                     
  $mail->SMTPAuth   = true; 

  $to='tomasandulescu4@protonmail.com';
  $nume='Tsan';

  $mail->SMTPSecure = "ssl";                 
  $mail->Host       = "mail.tsandulescu.daw.ssmr.ro";      
  $mail->Port       = 465;                   
  $mail->Username   = $username;  			// GMAIL username
  $mail->Password   = $password;            // GMAIL password
  $mail->AddAddress($to, $nume);
 
  $mail->SetFrom('feedback@tsandulescu.daw.ssmr.ro', 'Daw Email');
  $mail->Subject = 'Test';
